    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="lg:col-span-2 bg-white rounded-lg shadow p-6">
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <a href="#" class="text-blue-600 hover:text-blue-700 mt-2 inline-block">Pesan Service Sekarang</a>
                        </div>
                    @endif
                </div>
            ...
            <div class="mt-8 bg-white rounded-lg shadow p-6">
                <h2 class="text-lg font-semibold text-gray-900 mb-4">Kendaraan Terdaftar</h2>
