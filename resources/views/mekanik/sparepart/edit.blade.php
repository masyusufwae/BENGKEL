        ...
        <div class="bg-white shadow-sm rounded-xl border border-gray-100 p-8 max-w-2xl mx-auto">
            <form action="{{ route('mekanik.sparepart.update', $sparepart->id_part) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Kode Part <span class="text-red-500">*</span></label>
                        <input type="text" name="kode_part" value="{{ old('kode_part', $sparepart->kode_part) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_part" value="{{ old('nama_part', $sparepart->nama_part) }}" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="stok_minimum" value="{{ old('stok_minimum', $sparepart->stok_minimum) }}" min="0"
                               class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <input type="number" name="harga_jual" value="{{ old('harga_jual', $sparepart->harga_jual) }}" min="0" required
                ...
                <div class="flex gap-3">
                    <button type="submit" class="flex-1 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 font-medium shadow">
                        Update Sparepart
                    </button>
                    <a href="{{ route('mekanik.sparepart.index') }}" class="flex-1 bg-gray-500 text-white px-6 py-3 rounded-lg hover:bg-gray-600 font-medium text-center shadow">
                        Batal
                    </a>
                </div>
            </form>
