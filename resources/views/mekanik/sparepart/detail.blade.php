                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="bg-gray-50 p-4 rounded-xl border">
                                        ...
                                        <p class="text-3xl font-bold {{ $sparepart->stok <= $sparepart->stok_minimum ? 'text-red-600' : 'text-green-600' }}">
                                            {{ $sparepart->stok }}
                                        </p>
                                    </div>
                                    <div class="bg-gray-50 p-4 rounded-xl border">
                                        <p class="text-xs text-gray-500 mb-1">Stok Minimum</p>
                                        <p class="text-xl font-semibold text-orange-500">{{ $sparepart->stok_minimum }}</p>
                                    </div>
                                    <div class="bg-gray-50 p-4 rounded-xl border col-span-2">
                                        <p class="text-xs text-gray-500 mb-1">Satuan</p>
                                        <p class="text-base font-medium text-gray-700">{{ $sparepart->satuan ?? 'N/A' }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    <div class="flex justify-between items-center bg-gray-50 p-3 rounded-lg border">
                                        ...
                                        <span class="font-mono text-gray-700">Rp {{ number_format($sparepart->harga_beli) }}</span>
                                    </div>
                                    <div class="flex justify-between items-center bg-green-50 p-3 rounded-lg border border-green-100">
                                        ...
                                        <span class="font-bold text-green-600 text-lg">Rp {{ number_format($sparepart->harga_jual) }}</span>
                                    </div>
                                </div>
                            </div>
