...
<div class="py-8">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-sm rounded-xl border border-gray-100 overflow-hidden">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between border-b p-6 bg-gray-50">
                <div>
                    <h2 class="font-bold text-2xl text-black mb-1">
                        Detail Sparepart: {{ $sparepart->nama_part }}
                    </h2>
                    <p class="text-sm text-gray-500">Kode: {{ $sparepart->kode_part }}</p>
                </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="bg-gray-50 p-4 rounded-xl border">
                    ...
                    <p class="text-3xl font-bold
                        {{ $sparepart->stok <= $sparepart->stok_minimum ? 'text-red-600' : 'text-green-600' }}">
                        {{ $sparepart->stok }}
                    </p>
                </div>
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center bg-gray-50 p-3 rounded-lg border">
                    ...
                    <span class="font-mono text-gray-700">
                        Rp {{ number_format($sparepart->harga_beli) }}
                    </span>
                </div>
                ...
                <div class="flex justify-between items-center bg-green-50 p-3 rounded-lg border border-green-100">
                    ...
                    <span class="font-bold text-green-600 text-lg">
                        Rp {{ number_format($sparepart->harga_jual) }}
                    </span>
                </div>
        ...
        <div>
            ...
            <div class="bg-gray-50 p-4 rounded-xl border space-y-2 text-sm">
                ...
                <div class="flex justify-between">
                    ...
                    {{-- Kanan: Riwayat Penggunaan dalam card --}}
...
@foreach($sparepart->penggunaanSparepart->take(10) as $ps)
                                                <tr class="border-b hover:bg-gray-100">
                                                    ...
                                                    <td class="py-3 px-4 font-semibold">{{ $ps->jumlah }} {{ $sparepart->satuan ?? '' }}</td>
